...
class m161005_034400_cart extends \cmsgears\core\common\base\Migration {
	...
	private function upOrder() {
		...
		$this->createTable( $this->prefix . 'cart_order', [
			...
			'itemDiscount' => $this->float()->notNull()->defaultValue( 0 ),
			'tax1' => $this->float()->notNull()->defaultValue( 0 ),
			'tax2' => $this->float()->notNull()->defaultValue( 0 ),
			'tax3' => $this->float()->notNull()->defaultValue( 0 ),
			'tax4' => $this->float()->notNull()->defaultValue( 0 ),
			'tax5' => $this->float()->notNull()->defaultValue( 0 ),
