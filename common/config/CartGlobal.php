...
class CartGlobal {
	...
	const TYPE_INVOICE_ITEM	= 'invoice-item';
	...
	// Order Roles
	const ROLE_CART_ADMIN = 'cart-admin';
	...
	const PERM_ORDER_AUTHOR	= 'order-author';
	...
	const FIELD_SCHEME	= 'schemeField';
	...
	// Invoices
	const FIELD_INVOICE		= 'invoiceField';
	const FIELD_DATE_ISSUED	= 'issueDateField';
	const FIELD_DATE_DUE	= 'dueDateField';
